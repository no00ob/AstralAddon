...
namespace AstralVoyage.Items.Summoners
{
    public class BlackholeCrystal : ModItem
    {
        ...
        {
            return !NPC.AnyNPCs(mod.NPCType("GuardianOfCosmos"));  //you can't spawn this boss multiple times
        }
        public override bool UseItem(Player player)
        {
            NPC.SpawnOnPlayer(player.whoAmI, mod.NPCType("GuardianOfCosmos"));   //boss spawn
