...
{
    public class CosmosBladeProjectile : ModProjectile
    {
        ...
        {
            {
                ...
                int num666 = 8;
                int num667 = Dust.NewDust(new Vector2(Projectile.position.X + (float)num666 + 6, Projectile.position.Y + (float)num666), Projectile.width - num666 * 2, Projectile.height - num666 * 2, 66, 0f, 0f, 0, new Color(255, 0, 220), 1.5f);  //projectile dust color
