...
namespace AstralVoyage.NPCs.GoC
{
    [AutoloadBossHead]
    public class GuardianOfCosmos : ModNPC
    {
        public override void SetDefaults()
        {
            npc.aiStyle = 5;  //5 is the flying AI
            npc.lifeMax = 750000;   //boss life
            npc.damage = 225;  //boss damage
            ...
            //music = MusicID.Boss2;
            music = mod.GetSoundSlot(SoundType.Music, "Sounds/Music/boss4");
            npc.netAlways = true;
        ...
        public override void BossLoot(ref string name, ref int potionType)
        {
            ...
            AstralVoyageWorld.downedGuardianOfCosmos = true;
        }
